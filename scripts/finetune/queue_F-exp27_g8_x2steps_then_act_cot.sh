...
CONFIG_FILE="F-exp27-aloha-object-gripper-binary_motion_delta005_s5_g8_x2steps.yaml"
RUN_LABEL="F-exp27-aloha-object-gripper-binary_motion_delta005_s5_g8_x2steps"
TRAIN_PORT="${TRAIN_PORT:-26029}"
...
echo "[$(date '+%Y-%m-%d %H:%M:%S')] finished ${RUN_LABEL}; starting act_cot hold; log=${hold_log}"
