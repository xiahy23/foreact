...
CONFIG_FILE="F-exp35-food_foreact_ep60-69_130-139_taillast_from_F-exp32_e20.yaml"
RUN_NAME="F-exp35-food_foreact_ep60-69_130-139_taillast_from_F-exp32_e20"
NUM_GPUS="${NUM_GPUS:-8}"
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1,2,3,4,5,6,7}"
MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-26035}"
