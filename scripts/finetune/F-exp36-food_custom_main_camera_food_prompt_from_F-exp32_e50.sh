...
CONFIG_FILE="F-exp36-food_custom_main_camera_food_prompt_from_F-exp32_e50.yaml"
RUN_NAME="F-exp36-food_custom_main_camera_food_prompt_from_F-exp32_e50"
NUM_GPUS="${NUM_GPUS:-8}"
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1,2,3,4,5,6,7}"
MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-26036}"
