...
CONFIG_FILE="F-exp44-three_object_foreact_from_F-exp31_s1_t2s_bs64x4_e50_nofilter.yaml"
RUN_NAME="F-exp44-three_object_foreact_from_F-exp31_s1_t2s_bs64x4_e50_nofilter"
NUM_GPUS="${NUM_GPUS:-4}"
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1,2,3}"
MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-26044}"
