...
CONFIG_FILE="F-exp43-wipe_mug_sponge_from_F-exp37_s1_t2s_bs64x1_e20.yaml"
RUN_NAME="F-exp43-wipe_mug_sponge_from_F-exp37_s1_t2s_bs64x1_e20_nofilter"
NUM_GPUS="${NUM_GPUS:-1}"
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0}"
MAIN_PROCESS_PORT="${MAIN_PROCESS_PORT:-26043}"
