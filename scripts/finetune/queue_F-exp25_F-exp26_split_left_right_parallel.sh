...
run_experiment \
  "F-exp25-eggplant-potato-gripper-binary_left_first_motion_delta005_s5_t2s.yaml" \
  "26027" \
  "F-exp25-eggplant-potato-gripper-binary_left_first_motion_delta005_s5_t2s" \
  "$gpus_left" &
pid_left=$!

run_experiment \
  "F-exp26-eggplant-potato-gripper-binary_right_first_motion_delta005_s5_t2s.yaml" \
  "26028" \
  "F-exp26-eggplant-potato-gripper-binary_right_first_motion_delta005_s5_t2s" \
  "$gpus_right" &
pid_right=$!
