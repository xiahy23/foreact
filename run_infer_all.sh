...
NUM_GPUS=6
PROCS_PER_GPU=3
NUM_WORKERS=$((NUM_GPUS * PROCS_PER_GPU))  # 18

PYTHON="/media/raid/workspace/liyan/project/miniconda3/envs/foreact/bin/python"
SCRIPT_DIR="/media/raid/workspace/liyan/xiahongyu/foreact_2"
CHECKPOINT="./checkpoints/checkpoint-43735"
VIDEO_DIR="./Dataset/bridge_orig_lerobot/videos"
COT_PATH="./Dataset/bridge_orig_lerobot/cot_by_episode.json"
